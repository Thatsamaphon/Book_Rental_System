...
<body>
  <section>
    ...
    <div class="content">
      <h3 style="text-align:center; color: #386641; font-size: 40px; padding-top: 50px;">Update Books</h3>
      <section class="menu-content">
        <?php
         $conn = new mysqli("localhost","root","","registration_system");
         $sql = "SELECT * FROM book natural join type join author using(author_id)";
         ...
         if(mysqli_num_rows($result1) > 0) {
           while($row1 = mysqli_fetch_assoc($result1)){
               ...
               ?>
         <a href="updateBook.php?id=<?php echo($book_id) ?>">
         <div class="sub-menu">
